    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
		  ...
		  <h1 class="h3 mb-2 text-gray-800">Recruiter List</h1>
         ...
         <div class="container">
         	<div class="row">
         	   <div class="col-12">
          		<!-- Page Heading -->    
		            <c:url value="/recruiter-add" var="add"></c:url>
					<a href="${add }" class="btn btn-primary mb-3 float-right">
						<i class="fa fa-plus-circle mr-1"></i>Add New Recruiter</a>
				</div>
			</div>
          <!-- DataTales Example -->
          <h2>DataTables</h2>
        ...
        <tbody>
          <c:forEach items="${recruiters }" var="r">
                		<tr>
	                		...
	                		<td>
								<c:url value="/recruiter-edit" var="action">
									<c:param name="recruiterid">${r.id }</c:param>
								</c:url>
								<a href="${action }" class="btn btn-outline-success">Edit</a>
							</td>
							<td>
								<c:url var="delete" value="/recruiter-delete">
									<c:param name="recruiterid">${r.id }</c:param>
								</c:url>
